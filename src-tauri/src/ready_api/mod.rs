...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            local_pool::commands::gateway::reveal_local_gateway_api_key,
            local_pool::commands::gateway::rotate_local_gateway_api_key,
            ...
            local_pool::commands::remote_server::reveal_remote_gateway_api_key,
            local_pool::commands::remote_server::rotate_remote_gateway_api_key,
